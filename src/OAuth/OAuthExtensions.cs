...
public static class OAuthExtensions
{
        ...
        string basePath = "/oauth")
    {
        ...
        {
            var userContext = GetAuthenticatedUser(context);
...
<noscript>
  ...
  <p>You may now close this window.</p>
    ...
    private static IUserContext? GetAuthenticatedUser(HttpContext context)
    {
        return context.Items.TryGetValue(typeof(IUserContext), out var userContextValue) &&
               userContextValue is IUserContext { IsAuthenticated: true } userContext
            ? userContext
            : null;
    }
}