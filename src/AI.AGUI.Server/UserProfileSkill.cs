...
public sealed class UserProfileSkill(IUserContextAccessor userContextAccessor) : AgentClassSkill<UserProfileSkill>
{
    ...
    protected override string Instructions => """
        ...
        1. Use the get_user_fullname script to retrieve the current authenticated user's display name.
    ...
    /// </summary>
    [AgentSkillScript("get_user_fullname")]
    [Description("Returns the current authenticated user's full name from the current request identity.")]
