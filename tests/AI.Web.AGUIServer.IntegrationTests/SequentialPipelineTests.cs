...
[TestClass]
public sealed class SequentialPipelineTests
{
    ...
    {
        _factory = new AGUIServerFactory(new SequentialPipelineTestModule());
    ...
    [TestMethod]
    public async Task Pipeline_AGUIEndpoint_ReturnsSSEContentType()
    {
        var payload = new
        {
    ...
    [TestMethod]
    public async Task Pipeline_AGUIEndpoint_ReturnsNonEmptyStream()
    {
        var payload = new
        {
            threadId = "test-thread",
